        ...
        <AddMain className="container">
          ...
          <AddRight className="flexNullCenter">
              <AddImgWrapp1 className="flexCenter">
                <img src={image1 ? 'http://localhost:80/reelsvideoapis/Reels/DashData/' + image1 : ContactImg1} alt="office" />
              </AddImgWrapp1>
              <div style={{flex: 1}}>
                <AddImgWrapp2>
                  <img src={image2 ? 'http://localhost:80/reelsvideoapis/Reels/DashData/' + image2 : ContactImg2} alt="office" />
                </AddImgWrapp2>
                <AddImgWrapp3>
                  <img src={image3 ? 'http://localhost:80/reelsvideoapis/Reels/DashData/' + image3 : ContactImg2} alt="office" />
                </AddImgWrapp3>
              </div>
          </AddRight>
        </AddMain>
