              ...
              <AddRightInner>
                <div className="flexNullCenter">
                  <AddImgWrapp1 className="flexCenter">
                    <img src={image1 ? 'http://localhost:8080/reelsvideoapis/Reels/DashData/' + image1 : AddImage1} alt="office" />
                  </AddImgWrapp1>
                  <AddImgWrapp2>
                    <img src={image2 ? 'http://localhost:8080/reelsvideoapis/Reels/DashData/' + image2 : AddImage2} alt="office" />
                  </AddImgWrapp2>
                </div>
                <div className="flexNullCenter">
                  <AddImgWrapp3>
                    <img src={image3 ? 'http://localhost:8080/reelsvideoapis/Reels/DashData/' + image3 : AddImage3} alt="office" />
                  </AddImgWrapp3>
                  <AddImgWrapp4>
                    <img src={image4 ? 'http://localhost:8080/reelsvideoapis/Reels/DashData/' + image4 : AddImage4} alt="office" />
                  </AddImgWrapp4>
                </div>
              </AddRightInner>
            </AddRight>
